...
func _disable_buttons():
	_topButton.disabled = true
	_botButton.disabled = true


# needs the singleton
func _top_clicked():
	create_line2_nodes()
	_find_and_connect(path_top_character, name_top_character, path_bot_character, name_bot_character)
	_disable_buttons()


func _bot_clicked():
	create_line2_nodes()
	_find_and_connect(path_bot_character, name_bot_character, path_top_character, name_top_character)
	_disable_buttons()
